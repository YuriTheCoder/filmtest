...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', isLoading, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      ...
      secondary: 'bg-bg-card text-text-primary border border-white/10 hover:bg-bg-secondary focus:ring-accent-primary',
      ...
      ghost: 'text-text-primary hover:bg-bg-card focus:ring-accent-primary',
